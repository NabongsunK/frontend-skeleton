            ...
            <div className="col-lg-3">
              <ul className="nav nav-tabs flex-column">
                <li className="nav-item">
                  <Link className="nav-link active show" data-bs-toggle="tab" to="#tab-1">Modi sit est</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" data-bs-toggle="tab" to="#tab-2">Unde praesentium sed</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" data-bs-toggle="tab" to="#tab-3">Pariatur explicabo vel</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" data-bs-toggle="tab" to="#tab-4">Nostrum qui quasi</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" data-bs-toggle="tab" to="#tab-5">Iusto ut expedita aut</Link>
                </li>
              </ul>
            </div>
